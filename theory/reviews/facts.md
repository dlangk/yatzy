...
> Revised 2026-07: all 117 rows were re-verified by an adversarial review
> (see `accuracy-review-2026-07.md`). Line references were refreshed
> programmatically; values corrected where the underlying docs were fixed
> (bonus rate, near-origin fit, reachable-state count, theta sweep rows).
> Rows that depend on data not on disk (full 37-theta sweep, max-policy
> simulation, theta=0.07 disagreement analysis) are recorded there as
> "not re-verified".
...
|---|-------|-------|--------|------|---------|----------|
| 1 | Total state slots (upper × categories) | 2,097,152 | foundations/algorithm-and-dp.md | 63 | I | ✓ |
...
| 4 | Reachable states (after pruning, incl. 64 terminal) | 1,430,528 | foundations/algorithm-and-dp.md | 13 | I | ✓ |
| 5 | Pruning fraction | 31.8% | lab-reports/cache-hierarchy-targeting.md | 24 | I | ✓ |
| 6 | Distinct dice outcomes (5d6) | 252 | foundations/algorithm-and-dp.md | 19 | I | ✓ |
| 7 | Unique keep-multisets per outcome | 462 | foundations/algorithm-and-dp.md | 20 | I | ✓ |
| 8 | Non-zero keep entries (deduped) | 4,368 | lab-reports/cache-hierarchy-targeting.md | 117 | I | ✓ |
| 9 | Raw keep masks per dice set | 31 | lab-reports/cache-hierarchy-targeting.md | 24 | I | |
| 10 | Average unique keeps per dice set | 16.3 | lab-reports/cache-hierarchy-targeting.md | 40 | I | |
...
| 13 | Upper bonus value | 50 points | foundations/algorithm-and-dp.md | 5 | I | ✓ |
...
| 15 | State array size (f32) | ~16 MB | lab-reports/cache-hierarchy-targeting.md | 40 | II | ✓ |
| 16 | KeepTable working set | 51 KB | lab-reports/cache-hierarchy-targeting.md | 25 | II | |
| 17 | Dense transition table | 16.3 MB (79% zeros) | lab-reports/cache-hierarchy-targeting.md | 39,44 | II | |
| 18 | Sparse CSR format | 5.1 MB | lab-reports/cache-hierarchy-targeting.md | 59 | II | |
| 19 | Original C solver time | ~20 min | lab-reports/optimization-log.md | 9 | II | ✓ |
| 20 | Final optimized time (EV, θ=0) | ~1.10 s | lab-reports/optimization-log.md | 246 | II | ✓ |
...
| 24 | NEON registers | 32 × 128-bit | lab-reports/neon-intrinsics.md | 8 | II | |
...
| 30 | SLC cache | ~48 MB | lab-reports/cache-hierarchy-targeting.md | 14 | II | |
...
| 33 | f32 ordering flips | 22 out of 1.43M | lab-reports/hardware-and-hot-path.md | 227 | II | |
...
| # | Claim | Value | Source | Line | Section | Verified |
|---|-------|-------|--------|------|---------|----------|
| 35 | EV-optimal mean score | 248.4 | foundations/optimal-play-and-distributions.md | 36 | III | ✓ |
| 36 | Standard deviation | 38.5 | foundations/optimal-play-and-distributions.md | 37 | III | ✓ |
| 37 | Max-policy precomputed EV | 374 | foundations/optimal-play-and-distributions.md | 48 | III | |
| 38 | Max-policy simulated mean | 118.7 | foundations/optimal-play-and-distributions.md | 48 | III | |
| 39 | Bonus hit rate (θ=0) | ~90% | foundations/optimal-play-and-distributions.md | 65 | III | |
| 40 | Yatzy probability (θ=0) | ~39% | foundations/optimal-play-and-distributions.md | 66 | III | |
...
| 46 | Heuristic vs optimal gap | ~82 pts | research/human-cognition-and-compression.md | 14 | III | ✓ |
...
| 51 | Solver upper bonus rate | ~90% (89.77%) | strategy/strategy-guide.md | 7 | III | |
...
| 60 | Sparse grid count | 17 θ values (+ 1 overlap) | strategy/theta-sweep-architecture.md | 214 | IV | |
...
| 65 | Mean loss quadratic fit | 247.0 − 9.9θ − 602θ² | strategy/theta-sweep-architecture.md | 58 | IV | |
| 66 | Std gain quadratic fit | 39.5 + 53.5θ − 17θ² | strategy/theta-sweep-architecture.md | 164 | IV | |
...
| 78 | Bonus rate entering final turn (start-of-turn-15; end-of-game rate is 89.8%) | 83.6% | strategy/risk-sensitive-strategy.md | 235 | V | |
...
| 86 | Human-level score range | 220–230 | research/human-cognition-and-compression.md | 176 | VI | |
| 87 | Training data export | 200K games | research/human-cognition-and-compression.md | 83 | VI | |
| 88 | Export throughput | 22K games/sec | lab-reports/rosetta-distillation.md | 44 | VI | |
| 89 | Best RL score (literature) | ~236 | research/rl-and-ml-approaches.md | 19 | VI | |
...
| 91 | Category rules extracted | 100 | lab-reports/rosetta-distillation.md | 83 | VII | |
| 92 | Category uncovered rate | 0.8% | lab-reports/rosetta-distillation.md | 83 | VII | |
| 93 | Reroll 1 uncovered rate | 7.5% | lab-reports/rosetta-distillation.md | 84 | VII | |
| 94 | Reroll 2 uncovered rate | 3.0% | lab-reports/rosetta-distillation.md | 85 | VII | |
...
| 99 | Scaling: 0 rules EV | 196.7 | lab-reports/scaling-laws.md | 57 | VII | |
...
| 106 | Quiz scenarios | 30 | research/human-cognition-and-compression.md | 40 | VIII | |
| 107 | Q-grid combinations | 108 (6θ × 6γ × 3d) | research/human-cognition-and-compression.md | 57 | VIII | |
| 108 | Player card grid | 648 combos × 10K games | strategy/applications-and-appendices.md | 18 | VIII | ✓ |
| 109 | Grid precomputation time | ~2.5 min | strategy/applications-and-appendices.md | 18 | VIII | |
...
| 111 | Oracle total on-disk | ~3.17 GB | lab-reports/oracle-policy.md | 275 | II | |
| 112 | Oracle MC throughput | 5.6M games/s | lab-reports/density-condensation.md | 88 | II | ✓ |
| 113 | Lockstep MC throughput | 232K games/s | lab-reports/oracle-policy.md | 94 | II | |
| 114 | Density evolution (non-oracle) | ~381 s | lab-reports/optimization-log.md | 272 | II | |
| 115 | Density evolution (oracle) | 3.0 s | lab-reports/density-condensation.md | 112 | II | ✓ |
| 116 | Oracle density speedup | 126× | lab-reports/density-condensation.md | 19 | II | ✓ |
| 117 | American Yahtzee EV (literature) | 254.59 | research/exact-solver-survey.md | 3 | I | |
