...
> **This is the legacy C implementation.** The primary backend is now the [Rust version](../solver/) (`solver/`), which produces bit-identical output with better safety, simpler builds, and comparable performance. This code is kept for reference.
